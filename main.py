...
def covid19prediction():
    plt.style.use("ggplot")

    df0 = pd.read_csv("DataSets/CONVENIENT_global_confirmed_cases.csv")
    df1 = pd.read_csv("DataSets/CONVENIENT_global_deaths.csv")
    ...
    world.head()
    continent = pd.read_csv("DataSets/continents2.csv")
    ...
    forecast = model.df_forecast[["ds", "yhat_lower", "yhat_upper", "yhat"]].tail(30).reset_index().set_index(
